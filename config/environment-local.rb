...
Rails::Initializer.run do |config|
  ...
  config.gem "paperclip",         :version => '2.3.9' #gem install paperclip -v=2.3.9 --no-ri --no-rdoc
  ...
  #config.gem "rails-geocoder",    :version => '0.9.8'
  ...
  #config.gem "cocaine",           :version => '0.4.2'
  #config.gem "actionwebservice",  :version => '1.2.6'
