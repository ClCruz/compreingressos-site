class CidadeVisor < ActiveRecord::Base
  belongs_to :cidades
  ...
  has_attached_file :imagem,
                    :path => ":rails_root/public/images/cidade_visores/:id/visor.:extension",
                    :url => "/images/cidade_visores/:id/visor.:extension"
  ...
  def definir_ordem
    obj = CidadeVisor.find(:last, :order => :ordem)
    if obj
