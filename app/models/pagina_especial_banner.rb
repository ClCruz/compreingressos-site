class PaginaEspecialBanner < ActiveRecord::Base
	...
	has_attached_file :imagem,
	                :path => ":rails_root/public/images/pagina_especial_banners/:id/visor.:extension",
	                :url => "/images/pagina_especial_banners/:id/visor.:extension"
	...
	def definir_ordem
		obj = PaginaEspecialBanner.find(:last, :order => :ordem)
		if obj
